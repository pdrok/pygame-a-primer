...
# Update to conform to flake8 and black standars
...
# The surface draw on the screen is now an attribute of 'player'
...
class Enemy(pygame.sprite.Sprite):
    ...
    # Rename the sprite when it passes the left edge of the screen
    def update(self):
...
# Use and image for a better-looking sprite
...
while running:
    ...
    # Ensure program maintains a rate of 30 frame per second
    clock.tick(30)
